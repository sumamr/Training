...
using UpdationofLocalbusinessProject.Models;

namespace UpdationofLocalbusinessProject.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ServiceprovidersController : ControllerBase
    {
        private readonly CUSERSSUMAMRDESKTOPTRAININGCPGMSLOCALBUSINESSLOCALBUSINESSAPP_DATALOCALBUSINESSDBMDFContext _context;

        public ServiceprovidersController(CUSERSSUMAMRDESKTOPTRAININGCPGMSLOCALBUSINESSLOCALBUSINESSAPP_DATALOCALBUSINESSDBMDFContext context)
        {
            _context = context;
        }
